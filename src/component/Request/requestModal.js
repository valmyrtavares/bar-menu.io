  ...
  const addRequestUser = async (data) => {
    try {
      const userNewRequest = {
        ...
        tableNumber: global.orderBeingEdited 
          ? (global.orderBeingEdited.tableNumber || localStorage.getItem('tableNumber')) 
  ...
  const sendOrderToKitchenOnly = async () => {
    ...
    try {
      ...
      if (data && data.request) {
        ...
        const currentTable = manualTableNumber || localStorage.getItem('tableNumber');
        ...
        if (!orderAddedOrUpdated) {
          const newRequestForKitchen = {
            ...
            tableNumber: manualTableNumber || currentTable || null,
          };
          
          if (manualTableNumber) {
            setTableAssignedInThisSession(true);
          }
